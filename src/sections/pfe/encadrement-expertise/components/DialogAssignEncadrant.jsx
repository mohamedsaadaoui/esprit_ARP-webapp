...
export default function AssignEncadrantDialog({ openDialog, handleCloseDialog, studentId,refreshData }) {
  ...
  const handleConfirm = () => {
    ...
    EncadrementExpertiseService
      .AffectEncadrant(student.etudiantId, mentor.idEmploye)
      .then((response) => {
        refreshData();
  ...
  return (
    <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
      <DialogTitle>Assigner un encadrant</DialogTitle>
...
AssignEncadrantDialog.propTypes = {
